...
public class RoomiePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Roomie";
	...
	private RoomiePersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new RoomiePersistentManager();
		}
