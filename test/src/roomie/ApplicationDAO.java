...
public class ApplicationDAO {
	public static Application loadApplicationByORMID(roomie.Tenant tenant, roomie.House house) throws PersistentException {
		try {
	...
	public static Application getApplicationByORMID(roomie.Tenant tenant, roomie.House house) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static Application loadApplicationByORMID(roomie.Tenant tenant, roomie.House house, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static Application getApplicationByORMID(roomie.Tenant tenant, roomie.House house, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static Application loadApplicationByORMID(PersistentSession session, roomie.Tenant tenant, roomie.House house) throws PersistentException {
		try {
			Application application = new roomie.Application();
	...
	public static Application getApplicationByORMID(PersistentSession session, roomie.Tenant tenant, roomie.House house) throws PersistentException {
		try {
			Application application = new roomie.Application();
			application.setTenant(tenant);
			application.setHouse(house);
	...
	public static Application loadApplicationByORMID(PersistentSession session, roomie.Tenant tenant, roomie.House house, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			Application application = new roomie.Application();
			application.setTenant(tenant);
			application.setHouse(house);
	...
	public static Application getApplicationByORMID(PersistentSession session, roomie.Tenant tenant, roomie.House house, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			Application application = new roomie.Application();
			application.setTenant(tenant);
			application.setHouse(house);
	...
	public static Application createApplication() {
		return new roomie.Application();
	}
	
	public static boolean save(roomie.Application application) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.Application application) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.Application application) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.Application application) throws PersistentException {
		try {
