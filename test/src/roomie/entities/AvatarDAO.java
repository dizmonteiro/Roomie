...
public class AvatarDAO {
	...
	public static Avatar loadAvatarByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Avatar) session.load(roomie.entities.Avatar.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Avatar getAvatarByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Avatar) session.get(roomie.entities.Avatar.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Avatar loadAvatarByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Avatar) session.load(roomie.entities.Avatar.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Avatar getAvatarByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Avatar) session.get(roomie.entities.Avatar.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAvatar(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.entities.Avatar as Avatar");
		if (condition != null)
	...
	public static Avatar createAvatar() {
		return new roomie.entities.Avatar();
	}
	
	public static boolean save(roomie.entities.Avatar avatar) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.entities.Avatar avatar) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.entities.Avatar avatar) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.entities.Avatar avatar) throws PersistentException {
		try {
