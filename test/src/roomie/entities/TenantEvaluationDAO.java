...
public class TenantEvaluationDAO {
	public static TenantEvaluation loadTenantEvaluationByORMID(roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant) throws PersistentException {
		try {
	...
	public static TenantEvaluation getTenantEvaluationByORMID(roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static TenantEvaluation loadTenantEvaluationByORMID(roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static TenantEvaluation getTenantEvaluationByORMID(roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static TenantEvaluation loadTenantEvaluationByORMID(PersistentSession session, roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant) throws PersistentException {
		try {
			TenantEvaluation tenantevaluation = new roomie.entities.TenantEvaluation();
			tenantevaluation.setEvaluatorTenant(evaluatorTenant);
			tenantevaluation.setEvaluatedTenant(evaluatedTenant);
			
			return (TenantEvaluation) session.load(roomie.entities.TenantEvaluation.class, tenantevaluation);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static TenantEvaluation getTenantEvaluationByORMID(PersistentSession session, roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant) throws PersistentException {
		try {
			TenantEvaluation tenantevaluation = new roomie.entities.TenantEvaluation();
			tenantevaluation.setEvaluatorTenant(evaluatorTenant);
			tenantevaluation.setEvaluatedTenant(evaluatedTenant);
			
			return (TenantEvaluation) session.get(roomie.entities.TenantEvaluation.class, tenantevaluation);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static TenantEvaluation loadTenantEvaluationByORMID(PersistentSession session, roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			TenantEvaluation tenantevaluation = new roomie.entities.TenantEvaluation();
			tenantevaluation.setEvaluatorTenant(evaluatorTenant);
			tenantevaluation.setEvaluatedTenant(evaluatedTenant);
			
			return (TenantEvaluation) session.load(roomie.entities.TenantEvaluation.class, tenantevaluation, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static TenantEvaluation getTenantEvaluationByORMID(PersistentSession session, roomie.entities.Tenant evaluatorTenant, roomie.entities.Tenant evaluatedTenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			TenantEvaluation tenantevaluation = new roomie.entities.TenantEvaluation();
			tenantevaluation.setEvaluatorTenant(evaluatorTenant);
			tenantevaluation.setEvaluatedTenant(evaluatedTenant);
			
			return (TenantEvaluation) session.get(roomie.entities.TenantEvaluation.class, tenantevaluation, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryTenantEvaluation(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.entities.TenantEvaluation as TenantEvaluation");
		if (condition != null)
	...
	public static TenantEvaluation createTenantEvaluation() {
		return new roomie.entities.TenantEvaluation();
	}
	
	public static boolean save(roomie.entities.TenantEvaluation tenantEvaluation) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.entities.TenantEvaluation tenantEvaluation) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.entities.TenantEvaluation tenantEvaluation) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.entities.TenantEvaluation tenantEvaluation) throws PersistentException {
		try {
