...
public class LandlordDAO {
	...
	public static Landlord loadLandlordByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Landlord) session.load(roomie.entities.Landlord.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Landlord getLandlordByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Landlord) session.get(roomie.entities.Landlord.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Landlord loadLandlordByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Landlord) session.load(roomie.entities.Landlord.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Landlord getLandlordByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Landlord) session.get(roomie.entities.Landlord.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryLandlord(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.entities.Landlord as Landlord");
		if (condition != null)
	...
	public static Landlord createLandlord() {
		return new roomie.entities.Landlord();
	}
	
	public static boolean save(roomie.entities.Landlord landlord) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.entities.Landlord landlord) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.entities.Landlord landlord) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.entities.Landlord landlord) throws PersistentException {
		try {
