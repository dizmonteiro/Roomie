...
public class HouseDAO {
	...
	public static House loadHouseByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (House) session.load(roomie.entities.House.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static House getHouseByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (House) session.get(roomie.entities.House.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static House loadHouseByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (House) session.load(roomie.entities.House.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static House getHouseByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (House) session.get(roomie.entities.House.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryHouse(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.entities.House as House");
		if (condition != null)
	...
	public static House createHouse() {
		return new roomie.entities.House();
	}
	
	public static boolean save(roomie.entities.House house) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.entities.House house) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.entities.House house) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.entities.House house) throws PersistentException {
		try {
