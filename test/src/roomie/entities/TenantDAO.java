...
public class TenantDAO {
	...
	public static Tenant loadTenantByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Tenant) session.load(roomie.entities.Tenant.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tenant getTenantByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Tenant) session.get(roomie.entities.Tenant.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tenant loadTenantByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tenant) session.load(roomie.entities.Tenant.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tenant getTenantByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tenant) session.get(roomie.entities.Tenant.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryTenant(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.entities.Tenant as Tenant");
		if (condition != null)
	...
	public static Tenant createTenant() {
		return new roomie.entities.Tenant();
	}
	
	public static boolean save(roomie.entities.Tenant tenant) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.entities.Tenant tenant) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.entities.Tenant tenant) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.entities.Tenant tenant) throws PersistentException {
		try {
