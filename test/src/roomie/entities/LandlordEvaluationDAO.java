...
public class LandlordEvaluationDAO {
	public static LandlordEvaluation loadLandlordEvaluationByORMID(roomie.entities.Landlord landlord, roomie.entities.Tenant tenant) throws PersistentException {
		try {
	...
	public static LandlordEvaluation getLandlordEvaluationByORMID(roomie.entities.Landlord landlord, roomie.entities.Tenant tenant) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static LandlordEvaluation loadLandlordEvaluationByORMID(roomie.entities.Landlord landlord, roomie.entities.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static LandlordEvaluation getLandlordEvaluationByORMID(roomie.entities.Landlord landlord, roomie.entities.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static LandlordEvaluation loadLandlordEvaluationByORMID(PersistentSession session, roomie.entities.Landlord landlord, roomie.entities.Tenant tenant) throws PersistentException {
		try {
			LandlordEvaluation landlordevaluation = new roomie.entities.LandlordEvaluation();
			landlordevaluation.setLandlord(landlord);
			landlordevaluation.setTenant(tenant);
			
			return (LandlordEvaluation) session.load(roomie.entities.LandlordEvaluation.class, landlordevaluation);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static LandlordEvaluation getLandlordEvaluationByORMID(PersistentSession session, roomie.entities.Landlord landlord, roomie.entities.Tenant tenant) throws PersistentException {
		try {
			LandlordEvaluation landlordevaluation = new roomie.entities.LandlordEvaluation();
			landlordevaluation.setLandlord(landlord);
			landlordevaluation.setTenant(tenant);
			
			return (LandlordEvaluation) session.get(roomie.entities.LandlordEvaluation.class, landlordevaluation);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static LandlordEvaluation loadLandlordEvaluationByORMID(PersistentSession session, roomie.entities.Landlord landlord, roomie.entities.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			LandlordEvaluation landlordevaluation = new roomie.entities.LandlordEvaluation();
			landlordevaluation.setLandlord(landlord);
			landlordevaluation.setTenant(tenant);
			
			return (LandlordEvaluation) session.load(roomie.entities.LandlordEvaluation.class, landlordevaluation, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static LandlordEvaluation getLandlordEvaluationByORMID(PersistentSession session, roomie.entities.Landlord landlord, roomie.entities.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			LandlordEvaluation landlordevaluation = new roomie.entities.LandlordEvaluation();
			landlordevaluation.setLandlord(landlord);
			landlordevaluation.setTenant(tenant);
			
			return (LandlordEvaluation) session.get(roomie.entities.LandlordEvaluation.class, landlordevaluation, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryLandlordEvaluation(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.entities.LandlordEvaluation as LandlordEvaluation");
		if (condition != null)
	...
	public static LandlordEvaluation createLandlordEvaluation() {
		return new roomie.entities.LandlordEvaluation();
	}
	
	public static boolean save(roomie.entities.LandlordEvaluation landlordEvaluation) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.entities.LandlordEvaluation landlordEvaluation) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.entities.LandlordEvaluation landlordEvaluation) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.entities.LandlordEvaluation landlordEvaluation) throws PersistentException {
		try {
