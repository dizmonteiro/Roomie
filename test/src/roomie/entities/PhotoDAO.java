...
public class PhotoDAO {
	...
	public static Photo loadPhotoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Photo) session.load(roomie.entities.Photo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Photo getPhotoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Photo) session.get(roomie.entities.Photo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Photo loadPhotoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Photo) session.load(roomie.entities.Photo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Photo getPhotoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Photo) session.get(roomie.entities.Photo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPhoto(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.entities.Photo as Photo");
		if (condition != null)
	...
	public static Photo createPhoto() {
		return new roomie.entities.Photo();
	}
	
	public static boolean save(roomie.entities.Photo photo) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.entities.Photo photo) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.entities.Photo photo) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.entities.Photo photo) throws PersistentException {
		try {
