...
public class PhotoDAO {
	...
	public static Photo loadPhotoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Photo) session.load(roomie.Photo.class, new Integer(ID));
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static Photo getPhotoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Photo) session.get(roomie.Photo.class, new Integer(ID));
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static Photo loadPhotoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Photo) session.load(roomie.Photo.class, new Integer(ID), lockMode);
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static Photo getPhotoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Photo) session.get(roomie.Photo.class, new Integer(ID), lockMode);
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static List queryPhoto(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.Photo as Photo");
	...
	public static Photo createPhoto() {
		return new roomie.Photo();
	}
	
	public static boolean save(roomie.Photo photo) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.Photo photo) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.Photo photo) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.Photo photo) throws PersistentException {
		try {
