...
public class RentHistoryDAO {
	public static RentHistory loadRentHistoryByORMID(roomie.House house, roomie.Tenant tenant) throws PersistentException {
		try {
	...
	public static RentHistory getRentHistoryByORMID(roomie.House house, roomie.Tenant tenant) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static RentHistory loadRentHistoryByORMID(roomie.House house, roomie.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static RentHistory getRentHistoryByORMID(roomie.House house, roomie.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = RoomiePersistentManager.instance().getSession();
	...
	public static RentHistory loadRentHistoryByORMID(PersistentSession session, roomie.House house, roomie.Tenant tenant) throws PersistentException {
		try {
			RentHistory renthistory = new roomie.RentHistory();
			renthistory.setHouse(house);
			renthistory.setTenant(tenant);
			
			return (RentHistory) session.load(roomie.RentHistory.class, renthistory);
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static RentHistory getRentHistoryByORMID(PersistentSession session, roomie.House house, roomie.Tenant tenant) throws PersistentException {
		try {
			RentHistory renthistory = new roomie.RentHistory();
			renthistory.setHouse(house);
			renthistory.setTenant(tenant);
			
			return (RentHistory) session.get(roomie.RentHistory.class, renthistory);
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static RentHistory loadRentHistoryByORMID(PersistentSession session, roomie.House house, roomie.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			RentHistory renthistory = new roomie.RentHistory();
			renthistory.setHouse(house);
			renthistory.setTenant(tenant);
			
			return (RentHistory) session.load(roomie.RentHistory.class, renthistory, lockMode);
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static RentHistory getRentHistoryByORMID(PersistentSession session, roomie.House house, roomie.Tenant tenant, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			RentHistory renthistory = new roomie.RentHistory();
			renthistory.setHouse(house);
			renthistory.setTenant(tenant);
			
			return (RentHistory) session.get(roomie.RentHistory.class, renthistory, lockMode);
		} catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
		}
	...
	public static List queryRentHistory(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From roomie.RentHistory as RentHistory");
	...
	public static RentHistory createRentHistory() {
		return new roomie.RentHistory();
	}
	
	public static boolean save(roomie.RentHistory rentHistory) throws PersistentException {
		try {
	...
	public static boolean delete(roomie.RentHistory rentHistory) throws PersistentException {
		try {
	...
	public static boolean refresh(roomie.RentHistory rentHistory) throws PersistentException {
		try {
	...
	public static boolean evict(roomie.RentHistory rentHistory) throws PersistentException {
		try {
